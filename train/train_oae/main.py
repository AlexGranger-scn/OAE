...
def main():
    parser = argparse.ArgumentParser(description='train OrderedAutoEncoder')
    parser.add_argument('--weights', default='', help='path to weight (to continue training)')
    parser.add_argument('--outf', default=None, help='path to store checkpoints')
    parser.add_argument('--log_path',type=str,default=None, help='record of training loss')
    parser.add_argument('--data_npy_path',type=str,default=None, help='path of x-vector')
    parser.add_argument('--train_data_split',type=str,default=None, help='randomly select 80% training data for training')
    parser.add_argument('--val_data_split',type=str,default=None, help='randomly select 20% training data for validation')
    ...
    parser.add_argument('--dimension', type=int, default=None, help='length of hashing binary')
    ...
    # setup net
    net = OrderedAutoEncoder(args.dimension)
    resume_epoch = 0
    print(net)
    if args.weights:
